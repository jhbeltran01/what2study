...
admin.site.register(models.StudypodReviewerAvailableQuestionType)
admin.site.register(models.StudypodDefinitionIsAnsweredCorrectly)
admin.site.register(models.StudypodEnumerationIsCorrectlyAnswered)